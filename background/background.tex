...
The search space of all possible hypotheses $\mathcal{H}$ is restricted by a language bias. The main types of the biases in ILP are:
\begin{itemize}
\item mode declarations,
\item determinations,
\item induction and production fields.
\end{itemize}
...
\subsubsection{Induction and production fields}
