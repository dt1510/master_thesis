...
{\color{red}TODO Ask a supervisor if including text verbatim is allowed and how to cite it.}
...
\subsubsection{Toplog top theory bias}
Construction of a top theory.

Construction of a top theory from the mode declarations.

\subsubsection{Construction of a mode declaration from the top theory\cite{muggleton2008}}
...
\begin{exmp}
For the following sentence there does not exist a mode declaration biased space that includes it:
