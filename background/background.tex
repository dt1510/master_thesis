...
Toplog is an ILP system implementing TDHD framework:
...
A Hail (Hybrid abductive inductive learning) ILP system extending the Progol's method of bottom generalization to \emph{kernel set generalization} with the methods of abductive logic programming.
...
Other ILP systems not classified include Golem, MC-Toplog, Metagol,
Spectre, EBG, Alecto, FOIL, Linus, Marvin, Mis, Confucius, Quinlan, ASPAL, Hyper,  Tilde, Hail, CF-induction.
