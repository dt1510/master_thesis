...
Aleph cannot explain the examples from the background knowledge with the predicates of arity greater than 1.
...
This restricts the hypotheses space to the clauses with monadic bodies unlike \tc{english\_couple} predicate of arity 2. However, learning of hypotheses with polyadic predicate symbols in their head is still possible.
