...
Consider the hypotheses space $\mathcal{H} \subseteq L$. An ILP problem is to find the axiomatization $A \in \mathcal{H}$ of the least Kolmogorov complexity of the theory of the elementary class of the models $\mathcal{M}$ satisfying $\mathcal{M} \models O \union B$ where $O$ is a set of the observations, $B$ is the background knowledge.
