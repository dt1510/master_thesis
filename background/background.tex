...
defined total ordering over the literals and $M$ be a set of mode declarations. $C = b_1, ..., b_n \implies h$ is in the definite mode language $L_{mode}$ (a \emph{mode declaration bias}) if and only if
1) h is the atom
