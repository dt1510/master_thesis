...
\subsubsection{Correspondence between mode declarations, determinations and production field}
A production field is clearly a generalization mode declarations and determinations.
...
However, not every production field bias can be expressed with mode declarations and determinations.
