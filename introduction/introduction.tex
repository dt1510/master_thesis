...
We would like to extend the newest theory in ILP that could serve in the future for the theoretical classification of ILP systems. We would like to realize theoretical extensions in an implementation to test the soundness of our ideas.
