...
\item formalization of the intuitive concepts,
\item theoretical classification of ILP systems.
\end{itemize}

\subsubsection{Experimental classification of ILP systems}
...
We would like to find the datasets of examples for which ILP systems produce
...
\subsubsection{Formalization of the intuitive concepts}
We would like to formalise the notions of a language bias used in implementations of ILP systems and establish a correspondence with a theoretical specification of a language bias.
\subsubsection{Theoretical classification of ILP systems}
We would like to formalise the systems 
