...
As the strengths and weaknesses of ILP systems are correlated with the defining properties induced by their approaches, one gains an understanding of the benefits of a particular approach. This often results in removing a black-white understanding of the value of ILP systems and aids in making an informed decision in selection an ILP system for a specific application.
