...
Each ILP system has its own set of allowed metaconstraints.
\begin{exmp}
...
\begin{remark}
ILP systems we classify allow only a specification of a conjunction of metaconstraints. However, from the theoretical point of view, their negations and disjunctions make sense and it is possible to design an ILP system with an extended metaconstraint specification.
\end{remark}
...
Given production fields defining the bias of mode declarations and determinations, productions fields with additional metaconstraints can be constructed.
...
\subsection{Metaconstraints}\label{classification_metaconstraints}
