...
In Imparo \tc{set\_max\_clauses(2)} defines clausal theories with at most 2 clauses,  \tc{set\_max\_clause\_length(6)} defines clausal theories with the maximum length of their clauses to be at most 6 literals and
\tc{set\_max\_var\_depth(4)} defines clausal theories with clauses of maximum variable depth 4 (definition \ref{definition_variable_depth}).
...
\begin{corollary}\label{bias_correspondence_corollary}
