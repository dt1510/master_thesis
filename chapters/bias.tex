...
First we present a theory of the language bias \ref{sec:background_language_bias}, then ILP systems are classified by their language bias \ref{sec:classification_language_bias} and by their search bias \ref{classification_by_search_bias}.
