\chapter{Issues in inductive logic programming}
The objective of this chapter is to analyse the central issues in inductive logic programming: ILP task definition, completeness by problem classes, hypothesis selection and hypothesis search in order to be able to compare theoretical frameworks and ILP systems in the chapter \nameref{chap:classification_of_ilp_systems} based on how they approach solving a particular issue.
...
\section{ILP task definition}\label{ilp_problem_definition}
