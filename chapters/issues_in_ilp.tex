...
\section{Completeness by input classes}
For an ILP task $f:I \mapsto O$ the properties of an input $I$ affect the computation of the output $O$. Inputs with the identical properties create a class of inputs. The objective of this section is extract the main properties of an input $I$ to provide the ground for the classification of ILP systems based on their ability to solve an ILP task on well-defined class of inputs in the chapter \fullref{chap:classification_of_ilp_systems}.
...
\section{Completeness by output classes}
