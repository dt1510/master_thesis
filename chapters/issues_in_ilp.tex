...
The objective of this section is to extract the properties of logical theories that may serve for the classification of ILP systems by completeness by problem class, by their hypothesis selection and by their bias.
