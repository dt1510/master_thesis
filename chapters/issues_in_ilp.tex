...
For analysing the properties of the logical theory, one has several conceptual divisions by which the properties can be grouped and analysed.
...
\begin{itemize}
\item \emph{properties of a predicate or a function symbol} are atomic properties as these are specifications of a definition of a particular symbol: an arity of a language symbol,
...
\item \emph{properties of a logic theory}.
\end{itemize}
...
\subsection{Expressivity}
Additional restrictions on the properties of the logical theories\fullref{sec:properties_of_logical_theory} on the input and output can make the definition of an ILP task more complete.
