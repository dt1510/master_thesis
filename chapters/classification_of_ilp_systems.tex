...
From consulting the source code comments of Toplog, one can find out that Toplog in addition to \tc{modeb}, \tc{modeh} declarations, Toplog uses a third kind of the mode declaration: \tc{modet} declaration.
