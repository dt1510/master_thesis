...
\begin{tabular}{| l | l | l | l | l | l | l |}
    \hline
    ILP system & Progol & Aleph & Toplog & Xhail & Imparo & Tal \\ \hline
   	Search direction & top-down & & & & &\\ \hline
\end{tabular}
\end{center}
...
\paragraph{Progol}
Progol searches a hypothesis top-down for hypotheses that subsume some bottom clause.\cite{nienhuys1997foundations}.
\paragraph{Aleph}
Aleph being based on Progol, constructs a bottom clause, 
\paragraph{Toplog}
\paragraph{Xhail}
\paragraph{Imparo}
\paragraph{Tal}
