...
\subsubsection{Bias}
A bias is an extension of a set of additional rules specifying an ILP task.

\begin{itemize}
\item \emph{discrete bias}
\item \emph{preferential bias} is a partial relation $<$ on a set of hypotheses $\mathcal{H}$, $< \subseteq \mathcal{H} \times \mathcal{H}$,
\end{itemize}
