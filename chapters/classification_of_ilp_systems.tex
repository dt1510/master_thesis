...
TODO: where to classify an ILP system and where to classify an ILP framework? How to link a framework to the system in a classification? Can I classify a theoretical framework and its correspondent implementation in one go/place?
...
In \nameref{sec:ilp_task_definition} of the chapter \nameref{chap:issues_in_inductive_logic_programming} we presented machine learning problems: explanatory induction, generalization; together with the properties positive examples, negative examples, semantics important for the comparison of the definitions of an ILP task.
