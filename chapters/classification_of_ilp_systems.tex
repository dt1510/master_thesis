...
The problem is that metaconstraints do not only specify the hypothesis bias and the hypothesis space, but they also specify how the search is performed. Let me make a natural structure.
