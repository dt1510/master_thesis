...
In this chapter we derive a unified definition of an ILP task for each ILP system and then experimentally classify ILP systems based on the problems they can solve and on their robustness as programs.
...
\captionof{table}{Summary of classification}
 \begin{tabular}{| l | l | l | l | l | l | l |}
    ...
    \hline
    \multicolumn{7}{|l|}{Meta-constraints \ref{classification_metaconstraints}} \\ \hline
