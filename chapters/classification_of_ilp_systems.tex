...
We classify ILP systems based on whether they can find a hypothesis for the same class of inputs and their correct hypothesis where a class is defined by some property on $B, E^+, E^-, \mathcal{H}$ and their correct hypothesis $H$.
