...
\begin{remark}
An extension of an ILP task definition defines a different ILP task. Later a correspondence between an ILP task defined by $D$ and an ILP task defined by an extension of $D$ will be shown.
\end{remark}
