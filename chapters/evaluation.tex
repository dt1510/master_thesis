...
To the author's knowledge, the best description of the language bias can be found in
\cite{muggleton1994inductive} that lists 4 notable frameworks for a language bias specification: the inductive logic programming language of
